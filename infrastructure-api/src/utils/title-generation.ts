...
import REGIONS from '../../../data/assets/regions.json';
...
const LOCATIONS = COUNCILS.concat(SCOTLAND_REGIONS).concat(NHSREGIONS).concat(REGIONS).concat(COUNTRIES).concat(UTLA_NAMES).concat(MSOA_NAMES).concat(NATIONS);
