...
export class OntoPageDto {
  ...
  public childrenPageIds?: Array<string> = undefined as any; // rest are built from hierarchy data structure
  public parentPageId?: string = undefined as any;
  public neighborPageIds?: string[] = undefined as any;
}
